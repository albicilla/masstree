//
// Created by albicilla on 2019/01/08.
//

#ifndef MASSTREE_MASTREE_H
#define MASSTREE_MASTREE_H
#include "debug.h"
...
search_core(const int key)
{
    ...
    for (int i = 0; i < n->nkey+1; i++) {
        if (n->key[i] == key) {
            ...
            //TODO
            cout<<"find value="<<datatable[n->key[i]].val<<endl;
